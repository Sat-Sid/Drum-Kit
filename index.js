...
document.addEventListener("keydown", function(event) {
  ...
  makeSound(event.key);    //makeSound(event) gives list of things which happened when key on keyboard was pressed, but in that we want to tape on to "key" so to get the key value
